//
// File generated by rootcint at Sun Mar 10 20:32:18 2019
...
static void G__setup_memvarPHSartre(void) {
   ...
   G__memvar_setup((void*)0,117,0,0,G__get_linked_tagnum(&G__PHSartre_DictLN_basic_ofstreamlEcharcOchar_traitslEchargRsPgR),G__defined_typename("ofstream"),-1,4,"myfile=",0,(char*)NULL);
   }
   G__tag_memvar_reset();
}
...
"d - - 10 - a d - - 10 - b", (char*)NULL, (void*) NULL, 0);
   ...
   // automatic destructor
   G__memfunc_setup("~PHSartre", 903, G__PHSartre_Dict_537_0_23, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 1);
...
G__linked_taginfo G__PHSartre_DictLN_basic_ofstreamlEcharcOchar_traitslEchargRsPgR = { "basic_ofstream<char,char_traits<char> >" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtablePHSartre_Dict() {
  G__PHSartre_DictLN_basic_ofstreamlEcharcOchar_traitslEchargRsPgR.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtablePHSartre_Dict() {
   ...
   G__get_linked_tagnum_fwd(&G__PHSartre_DictLN_basic_ofstreamlEcharcOchar_traitslEchargRsPgR);
